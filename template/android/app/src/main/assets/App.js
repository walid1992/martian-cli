...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/walid/Desktop/dev/index/index-frame/src/App.vue"
	  ...
	  data: function data() {
	    return {
	      tabItems: [{
	        ...
	        src: '' + _navigator2.default.getBaseUrl() + _route2.default.home + '.js',
	        visibility: 'visible'
	      }, {
	        index: 1,
	        title: '发起筹款',
	        ...
	        src: '' + _navigator2.default.getBaseUrl() + _route2.default.list + '.js',
	        visibility: 'hidden'
	      }, {
	        index: 2,
	        title: '我的',
	        ...
	        image: 'http://gtms03.alicdn.com/tps/i3/TB1LEn9MpXXXXaUXpXX9t7RGVXX-46-46.png',
	        selectedImage: 'http://gtms02.alicdn.com/tps/i2/TB1qysbMpXXXXcnXXXX9t7RGVXX-46-46.png',
	        src: '' + _navigator2.default.getBaseUrl() + _route2.default.mine + '.js',
	        visibility: 'hidden'
	      }]
	    };
	  },
